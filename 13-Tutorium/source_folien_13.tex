...
!*\onslide<3->*!    }
!*\onslide<3->*!
!*\onslide<3->*!    public int getNumSides() { return this.numSides; }
!*\onslide<3->*!    public double getCircumference() { return this.numSides * this.sideLength; }
...
\small\begin{enumerate}
    ...
    \item<3-> Wenn Sie die abstrakte Methode \bjava{public double getArea()} in den Subklassen implementieren, wird diese Methode dann überladen oder überschrieben? Begründen Sie ihre Antwort!
    ...
    \item<5-> In der Vorlage wird der Modifier \bjava{protected} für die Instanzvariablen verwendet. Könnte hier auch der Modifier \bjava{private} verwendet werden? Begründen Sie ihre Antwort!
    \end{enumerate}
\end{frame}
...
!*\onslide<3->*!public class PolygonTest {
!*\onslide<3->*!   public static void main(String[] args) {
!*\onslide<3->*!      RegularPolygon polygon = new EquilateralTriangle(3); // A 1
!*\onslide<3->*!      EquilateralTriangle triangle = (EquilateralTriangle)polygon; // A 2
!*\onslide<3->*!      Square square = new RegularPolygon(4, 4); // A 3
!*\onslide<3->*!   }
!*\onslide<3->*!}
\end{plainjava}
    \end{enumerate}
...
!*\onslide<3->*!public class PolygonAreaTest {
!*\onslide<3->*!    public static void main(String[] args) {
!*\onslide<3->*!        RegularPolygon polygon = new EquilateralTriangle(3);
!*\onslide<3->*!        System.out.println(polygon.getArea());
!*\onslide<3->*!
!*\onslide<3->*!        polygon = new Square(2);
!*\onslide<3->*!        System.out.println(polygon.getArea());
!*\onslide<3->*!    }
!*\onslide<3->*!}
\end{plainjava}
...
\small\begin{itemize}[<+(1)->]
    \itemsep5.5pt
    \item \textcolor{gray}{Ist die Implementation von \bjava{getArea()} Überladung oder Überschreiben?}\par\pause
    Überschreiben: die \say{implementierende} Methode hat die selbe Signatur (und ist sichtbar) \info{siehe \href{https://docs.oracle.com/javase/specs/jls/se17/jls17.pdf\#page=309}{JLS17 8.4.8.1} für die genauen Regeln}.
    ...
    \item<9-> \textcolor{gray}{Es wird der Modifier \bjava{protected} für die Instanzvariablen verwendet. Ginge auch \bjava{private}?}\par
    ...
    \onslide<12->{\infoblock{Man kööönte aber in diesem speziellen Fall auch eine neue Variable machen\ldots}}
\end{itemize}
\end{frame}
