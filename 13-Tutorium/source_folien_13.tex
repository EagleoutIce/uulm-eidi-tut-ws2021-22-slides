...
\small\begin{itemize}[<+(1)->]
    ...
    Sie wird überschrieben: die \say{implementierende} Methode hat die selbe Signatur (und ist sichtbar) \info{siehe \href{https://docs.oracle.com/javase/specs/jls/se17/jls17.pdf\#page=309}{JLS17 8.4.8.1} für die genauen Regeln}.
